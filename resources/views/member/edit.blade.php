      ...
      <div class="col-md-8 col-xl-6">
            ...
            <div class="d-flex">
              <div class="form-check me-3">
                <input class="form-check-input" type="radio" name="gender"
                  ...
                  {{ old('gender')??$member->gender=='Laki-laki' ? 'checked': '' }}>
                <label class="form-check-label" for="ada">Laki-laki</label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="gender"
                  id="Perempuan" value="Perempuan"
                  {{ old('gender')??$member->gender=='pinjam' ? 'checked': '' }}>
        ...
        @endphp
          <div class="mb-3">
            ...
            <select class="form-select" id="status_member" name="status_member">
                @foreach ($status as $data)
                   ...
                   <option value="{{ $data }}" {{ old('status_member')??$member->status_member==$data ? 'selected': '' }}>{{ $data}}</option>
                @endforeach
             </select>
          </div>
          <div class="mb-3">
            <label class="form-label" for="alamat">Alamat</label>
            <input type="text" id="alamat" name="alamat" value="{{ old('alamat') ?? $member->alamat }}"
          ...
          <div class="mb-3">
            ...
            <input type="email" id="email_member" name="email_member" value="{{ old('email_member') ?? $member->email_member }}"
          ...
          <div class="mb-3">
            ...
            <input type="number" id="nohp_member" name="nohp_member" value="{{ old('nohp_member') ?? $member->nohp_member}}"
